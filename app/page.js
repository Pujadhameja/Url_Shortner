      ...
      <section className="grid grid-cols-2 h-[50vh]">
        <div className="flex flex-col gap-4 items-center justify-center">
          ...
          <p className="px-56 text-center">
            Catering to your needs of a straightforward URL shortener to make your work easier we have come up with perfect solution. One Stop of all your problems and needs.
          </p>
